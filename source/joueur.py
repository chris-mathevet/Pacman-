...
def Joueur(couleur, nom, nb_points, nb_faux_mvt, pos_pacman, pos_fantome, objets):
    ...
    """
    new_joueur = {}
    new_joueur["couleur"] = couleur
    new_joueur["nom"] = nom
    new_joueur["nb_points"] = nb_points
    new_joueur["nb_faux_mouvements"] = nb_faux_mvt
    new_joueur["pos_pacman"] = pos_pacman
    new_joueur["pos_fantome"] = pos_fantome
    new_joueur["objets"] = objets
    return new_joueur
